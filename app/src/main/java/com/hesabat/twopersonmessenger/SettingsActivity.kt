...
class SettingsActivity:AppCompatActivity(){
    ...
    override fun onCreate(s:Bundle?){
        ...
        b.msgNotif.isChecked=p.getBoolean("msg",true);b.callSound.isChecked=p.getBoolean("call",true);b.callVibration.isChecked=p.getBoolean("vibrate",true);b.readReceipt.isChecked=p.getBoolean("read",true)
        val save={p.edit().putBoolean("msg",b.msgNotif.isChecked).putBoolean("call",b.callSound.isChecked).putBoolean("vibrate",b.callVibration.isChecked).putBoolean("read",b.readReceipt.isChecked).apply()}
        b.msgNotif.setOnCheckedChangeListener{_,_->save()};b.callSound.setOnCheckedChangeListener{_,_->save()};b.callVibration.setOnCheckedChangeListener{_,_->save()};b.readReceipt.setOnCheckedChangeListener{_,_->save()}
